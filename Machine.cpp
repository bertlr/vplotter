 ...
 */
Machine::Machine(double _BaseLength, double _X0, double _Y0, double _StepsPermm, int _z_down, int _z_up, int _bldc_ds) {          //RF: Dutycycle for the bldc motor. Added int bldc_ds
